...
#                       ukoliko sadrži komentar "//RETURN: <num>", nakon generisanja koda će se proveriti
#                       da li se povratna vrednost izgenerisanog koda poklapa sa navedenom
...
.PHONY: clean cleanall test archive
